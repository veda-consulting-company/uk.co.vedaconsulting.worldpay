...
class CRM_Core_Payment_WorldPay extends CRM_Core_Payment {
    ...
    function __construct( $mode, &$paymentProcessor ) {
       // CM: this is too noisy. Commenting out for now so we can look at the log file.
       // error_log(__FILE__.":".__FUNCTION__.": mode = $mode : paymentProcessor = ".print_r($paymentProcessor,true));

        // CM: hack to fix "Accessing static property as non static".
        // Will already be fixed in core upgrade.
        // $this->_mode = $mode;
        self::$_mode = $mode;
